...
class Agents:
    def __init__(self, n_obs, n_action):
        ...
        agent1.load_state_dict(torch.load(r'agents\random_network\agent1.pth'))

        agent2 = Actor(n_obs, n_action)
        agent2.load_state_dict(torch.load(r'agents\random_network\agent2.pth'))

        agent3 = Actor(n_obs, n_action)
        agent3.load_state_dict(torch.load(r'agents\random_network\agent3.pth'))
