    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        for agent in self.agents:
            ...
            if len(total_action_space) > 1:
                ...
                # in simple_spread environment, length just 1 (Discrete(5)), so this process will not process
        ...
        if agent.movable:
            ...
            if self.discrete_action_input:
                ...
                if self.force_discrete_action:
                    ...
                    action[0][d] = 1.0
                if self.discrete_action_space:
                    # the simple_spread environment is in here, e.g.,
                    # action space is discrete (finite action to choose) but value is continuous.
